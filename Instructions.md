...
// day changes with day, save diff entry for diff days- optional but good
...
* Allow a user to enter an event when they click a timeblock
 - each time block is a text area

* Save the event in local storage when the save button is clicked in that timeblock.
- save button saves to local storage and get confirmation it saved
